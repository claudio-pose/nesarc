...
if __name__ == "__main__":
    ...
    fra_overall = lib.FrequencyAnalysis(df_helper=dfh_overall)
    ...
    fra_dfh_sub_illegal_childhood = lib.FrequencyAnalysis(df_helper=dfh_sub_illegal_childhood)
    fra_dfh_sub_illegal_childhood.print_frequency_tables(['S12Q2A12'])
    ...
    fra_dfh_sub_anti_social = lib.FrequencyAnalysis(df_helper=dfh_sub_anti_social)
